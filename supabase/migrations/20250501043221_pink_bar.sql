/*
  # Add bid lifecycle and refund system

  1. Changes
    - Update bids table with new status options
    - Add balance column to users table
    - Create cancel_bid_and_refund function
    - Add RLS policies for bid management

  2. Security
    - Function runs with security definer
    - RLS policies ensure users can only manage their own bids
*/

-- Update bid status options
